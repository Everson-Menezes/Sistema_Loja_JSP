<%@ page contentType="text/html" language="java" import="java.sql.*"%>  
 ...
 <title>Consulta Itens Compraa</title>  
 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itenscompra.jsp?status=Consulta efetuada com sucesso&itc_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itenscompra.jsp?status=Registro n�o encontrado");  
       }  
