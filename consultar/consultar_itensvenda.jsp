<%@ page contentType="text/html" language="java" import="java.sql.*"%>  
 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itensvenda.jsp?status=Consulta efetuada com sucesso&itv_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itensvenda.jsp?status=Registro n�o encontrado");  
       }  
