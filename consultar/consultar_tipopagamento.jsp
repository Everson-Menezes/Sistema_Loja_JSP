<%@ page contentType="text/html" language="java" import="java.sql.*"%>  
 ...
 <%  
       ...
       {           
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/tipopagamento.jsp?status=Consulta efetuada com sucesso&tpg_codigo="+  
          ...
          response.sendRedirect("http://localhost:8084/sistema_loja_noturno/tipopagamento.jsp?status=Registro n�o encontrado");  
       }  
