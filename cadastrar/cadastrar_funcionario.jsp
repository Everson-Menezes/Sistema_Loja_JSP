...
<p><strong>Status:  
    <input name="statusField" disabled type="text" id="statusField" size="36" value="<%=request.getParameter("fun_codigoField")%> foi Cadastrar com sucesso">  
      </strong></p>  
</funm>  
</body>  
</html> 