...
<jsp:setProperty name="con" property="itv_valortotal" value='<%=(request.getParameter("fitv_valortotalField"))%>'/> 
...
<%      
   try {  
    ...
    if(request.getParameter("itv_codigoField").equals(temp.getString("itv_codigo")))  
       response.sendRedirect("http://localhost:8084/sistema_loja_noturno/itensvenda.jsp?status=Registro já existente");  
