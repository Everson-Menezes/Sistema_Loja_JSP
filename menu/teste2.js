function build_menu(tp,opc)
{
  ...
  for(i = 0; i < opc.length; i++)
  {
	...
	if (opc[i].href != null)
      td_f[i].innerHTML = '<a href="'+opc[i].href+'" class="A"><div align="center"><font face="verdana" size="3"><b>'+opc[i].descricao+'</b></font></div></a>';	
	else
      td_f[i].innerHTML = '<div align="center"><font face="verdana" size="4" color="#FFFFFF"><b>'+opc[i].descricao+'</b></font></div>';	
...
//	std_f[p].style.align = "left";
	...
	if (sopc[p].href != null)
	  std_f[p].innerHTML = '<a href="'+sopc[p].href+'" class="A"><div align="center"><font face="verdana" size="3"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+sopc[p].descricao+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></div></a>';
	else
	  std_f[p].innerHTML = '<div align="center"><font face="verdana" size="4" color="#FFFFFF"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+sopc[p].descricao+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></font></div>';
...
var op4 = new Array(1);
op4[0] = new CriaMenu("Ger. de Funcionários",null,"funcionario.jsp");


var op3 = new Array(3);
op3[0] = new CriaMenu("Ger. de Fornecedores",null,"fornecedor.jsp");
op3[1] = new CriaMenu("Ger. de Produtos",null,"produtos.jsp");
op3[2] = new CriaMenu("Ger. dos Tipos de Produto",null,"tipoproduto.jsp");


var op2 = new Array(4);
op2[0] = new CriaMenu("Ger. de Compras",null,"compras.jsp");
op2[1] = new CriaMenu("Ger. dos Itens de Compras",null,"itenscompra.jsp");
op2[2] = new CriaMenu("Ger. de Vendas",null,"vendas.jsp");
op2[3] = new CriaMenu("Ger. dos Itens de Venda",null,"itensvenda.jsp");

var op1 = new Array(4);
op1[0] = new CriaMenu("Ger. de Notas Fiscais",null,"notafiscal.jsp");
op1[1] = new CriaMenu("Ger. de Contas a pagar ",null,"contapagar.jsp");
op1[2] = new CriaMenu("Ger. de Contas a Receber",null,"contareceber.jsp");
op1[3] = new CriaMenu("Ger. dos Tipo de Pagamentos ",null,"tipopagamento.jsp");

var op = new Array(4);
op[0] = new CriaMenu("Administrativo",op1,null);
op[1] = new CriaMenu("Comercial",op2,null);
op[2] = new CriaMenu("Supply Chain",op3,null);
op[3] = new CriaMenu("Empresa",op4,null);

build_menu(1,op)

function Voltar (){
  response.sendRedirect("http://localhost:8084/sistema_loja_noturno/index.jsp");
}