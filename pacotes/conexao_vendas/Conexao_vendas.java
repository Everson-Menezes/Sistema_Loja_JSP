...
public class Conexao_vendas {
   ...
   public void inserirDados() {
      ...
      try {
         String query = "insert into tb_vendas(ven_codigo,tpg_codigo,fun_codigo,nf_codigo,ven_datavenda,ven_valortotal,ven_observacoes) "
               + "values(" + ven_codigo + "," + " \"" + tpg_codigo + "\",\"" + fun_codigo + "\"," + " \"" + nf_codigo
   ...
   public boolean alterarDados() {
      ...
      try {
         String query = "update tb_vendas set fun_codigo = \"" + fun_codigo + 
