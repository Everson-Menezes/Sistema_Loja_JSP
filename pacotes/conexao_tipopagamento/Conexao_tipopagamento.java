package conexao_tipopagamento;

import java.sql.*;

public class Conexao_tipopagamento {
    ...
    public void inserirDados() {
        ...
        try {
            String query = "insert into tb_tipopagto(tpg_codigo,tpg_descricao,tpg_qtde,tpg_ativo)"
                    + "values(" + tpg_codigo + "," + " \"" + tpg_descricao + "\",\"" + tpg_qtde + "\"," + " \""
                    + tpg_ativo + "\")";
    ...
    public boolean alterarDados() {
        ...
        try {
            String query = "update tb_tipopagto " + "set tpg_descricao = \"" + tpg_descricao + "\"," + "tpg_qtde = \""
                    + tpg_qtde + "\"," + "tpg_ativo = \"" + tpg_ativo + "\" " + "where tpg_codigo = " + tpg_codigo
                    + " ";
