...
public class Conexao_itensvenda {
    ...
    public void inserirDados() {
        ...
        try {
             String query = "insert into tb_itensvenda(itv_codigo,ven_codigo,pro_codigo,tpp_codigo,nf_codigo,fun_codigo,tpg_codigo,itv_embalagem,itv_qtde,itv_valorun,itv_desc,itv_valortotal)"
                    + "values(" + itv_codigo + "," + " \"" + ven_codigo + "\",\"" + pro_codigo + "\"," + " \""
                    + tpp_codigo + "\",\"" + nf_codigo + "\",\"" + fun_codigo + "\",\"" + tpg_codigo + "\",\"" + itv_embalagem + "\",\"" + itv_qtde + "\",\"" + itv_valorun + "\",\"" + itv_desc + "\",\"" +  itv_valortotal + "\")";
    ...
    public boolean alterarDados() {
        ...
        try {
            String query = "update tb_itensvenda set ven_codigo = \"" + ven_codigo + 
