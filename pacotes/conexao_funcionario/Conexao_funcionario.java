...
public class Conexao_funcionario {
    ...
    public void inserirDados() {
        ...
        try {
            String query = "insert into tb_funcionario(fun_codigo,fun_nome,fun_endereco,fun_numero,fun_bairro,fun_complemento,fun_cidade,fun_uf,fun_cnpjcpf,fun_rgie,fun_sexo,fun_nascimento,fun_telefone,fun_celular,fun_email,fun_salario)"
                    + "values(" + fun_codigo + "," + " \"" + fun_nome + "\",\"" + fun_endereco + "\"," + " \""
                    + fun_numero + "\",\"" + fun_bairro + "\",\"" + fun_complemento + "\",\"" + fun_cidade + "\",\"" + fun_uf + "\",\"" + fun_cnpjcpf + "\",\"" + fun_rgie + "\",\"" + fun_sexo + "\",\"" + fun_nascimento + "\",\"" + fun_telefone + "\",\"" + fun_celular + "\",\"" + fun_email + "\",\"" + fun_salario + "\")";
    ...
    public boolean alterarDados() {
        ...
        try {
            String query = "update tb_funcionario " + "set fun_nome = \"" + fun_nome + "\"," + "fun_endereco = \""
                    + fun_endereco + "\"," + "fun_numero = \"" + fun_numero + "\"," + "fun_bairro = \"" + fun_bairro + "\"," + "fun_complemento = \"" + fun_complemento + "\"," + "fun_cidade = \"" + fun_cidade + "\"," + "fun_uf = \"" + fun_uf + "\"," + "fun_cnpjcpf = \"" + fun_cnpjcpf + "\"," + "fun_rgie = \"" + fun_rgie + "\"," + "fun_sexo = \"" + fun_sexo + "\"," + "fun_nascimento = \"" + fun_nascimento + "\"," + "fun_telefone = \"" + fun_telefone + "\"," + "fun_celular = \"" + fun_celular + "\"," + "fun_email = \"" + fun_email
                    + "\"," + "fun_salario = \"" + fun_salario + "\" " + "where fun_codigo = " + fun_codigo
                    + " ";
