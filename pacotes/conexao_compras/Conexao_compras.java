...
public class Conexao_compras {
   ...
   public void inserirDados() {
      ...
      try {
         String query = "insert into tb_compras(com_codigo,tpg_codigo,for_codigo,nf_codigo,com_datacompra,com_valortotal,com_observacoes) "
               + "values(" + com_codigo + "," + " \"" + tpg_codigo + "\",\"" + for_codigo + "\"," + " \"" + nf_codigo
               + "\",\"" + com_datacompra + "\",\"" + com_valortotal + "\",\"" + com_observacoes + "\")";
   ...
   public boolean alterarDados() {
      ...
      try {
         String query = "update tb_compras set tpg_codigo = \"" + tpg_codigo + 
