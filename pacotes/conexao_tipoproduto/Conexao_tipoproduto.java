...
public class Conexao_tipoproduto {
    ...
    public void inserirDados() {
        ...
        try {
            String query = "insert into tb_tipoproduto(tpp_codigo,tpp_descricao)"
    ...
    public boolean alterarDados() {
        ...
        try {
            String query = "update tb_tipoproduto " + "set tpp_descricao = \"" + tpp_descricao + "\" " + "where tpp_codigo = " + tpp_codigo
                    + " ";
