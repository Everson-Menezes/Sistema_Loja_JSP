...
public class Conexao_produtos {
    ...
    public void inserirDados() {
        ...
        String query = "INSERT INTO tb_produtos(pro_codigo,pro_descricao,tpp_codigo,pro_precocusto,pro_precovenda,pro_estoque,pro_embalagem,pro_ipi) VALUES ('"+pro_codigo+"','"+pro_descricao+"','"+tpp_codigo+"','"+pro_precocusto+"','"+pro_precovenda+"','"+pro_estoque+"','"+pro_embalagem+"','"+pro_ipi+"')";
        try {
    ...
    public boolean alterarDados() {
        ...
        try {
            String query = "update tb_produtos set pro_descricao = \"" + pro_descricao + 
