...
public class Conexao_contareceber {
   ...
   public void inserirDados() {
      ...
      try {
         String query = "insert into tb_contareceber(cr_codigo,cr_valorconta,cr_datavencimento,cr_datarecebimento,nf_codigo,cr_observacoes) "
               + "values(" + cr_codigo + "," + " \"" + cr_valorconta + "\",\"" + cr_datavencimento + "\"," + " \"" + cr_datarecebimento
   ...
   public boolean alterarDados() {
      ...
      try {
         String query = "update tb_contareceber " + "set cr_valorconta = \"" + cr_valorconta + "\"," + "cr_datavencimento = \""
               + cr_datavencimento + "\"," + "cr_datavencimento = \"" + cr_datarecebimento + "\"," + "nf_codigo = \"" + nf_codigo
